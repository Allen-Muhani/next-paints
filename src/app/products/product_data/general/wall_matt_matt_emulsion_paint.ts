...
export const wall_matt_matt_emulsion_paint: Product = {
  id: 2,
  name: "Wall Matt Matt Emulsion Paint",
  briefDescription:
    "Is an interior-formulated paint for walls and ceilings based on a premium polyvinyl emulsion resin. It provides a highly durable sheen finish that is easy to clean and resistant to fading.",
  description:
  ...
  image: getUri(
    "/images/paint_thumbnails/Wall-matt-emuslion-paint-Bucket-thumb.png"
  ),
  type: "Decorative",
  sections: [
    sectionOne,
